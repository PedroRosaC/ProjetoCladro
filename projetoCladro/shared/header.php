...
<body>
    <header>
        ...
        <div>
            ...
            <div class="content">
                <button class="open" onclick="abrir()">
            ...
            if (@$_SESSION['user'] == 'pct') {
                echo '<div class="sidebar">
                        ...
                        <a class="a" href="solicitarConsulta.php">
                            <div class="itens"><img src="img/home.png" alt="homeimagem" class="icon whiteimg"><a class="texto">Solicitar Consulta</a>
                            </div>
                        </a>
                        <a class="a" href="#">
                            <div class="itens"><img src="img/home.png" alt="homeimagem" class="icon whiteimg"><a class="texto">Home</a>
                            </div>
                        </a>
                        <a class="a" href="#">
                            <div class="itens"><img src="img/home.png" alt="homeimagem" class="icon whiteimg"><a class="texto">Perfil</a>
                            </div>
                        </a>
                    </div>';
            }
